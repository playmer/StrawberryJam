...
#include "BlockAllocator.hpp"
  ...
  public:
    ...
    template <typename FunctionType, FunctionType aFunction, typename StringType = std::string, typename EventType = Event, typename ObjectType = EventHandler>
    ...
    template <typename FunctionType, FunctionType aFunction, typename StringType = std::string, typename ObjectType = EventHandler, typename EventType = Event>
